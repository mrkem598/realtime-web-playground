...
rtpg.string.connectRealtime = function() {
  ...
  rtpg.string.referenceStart.addEventListener(good.realtime.EventType.REFERENCE_SHIFTED, rtpg.string.onReferenceStartShifted);
  rtpg.string.referenceEnd.addEventListener(good.realtime.EventType.REFERENCE_SHIFTED, rtpg.string.onReferenceEndShifted);
};
